...
import { RegisterCredentials } from '@app/features/auth/domain/models/credentials.model';
import { SIGN_UP_USECASE } from '@app/features/auth/infrastructure/providers';
