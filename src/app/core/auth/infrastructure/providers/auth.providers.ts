 ...
 */
export const AUTH_REPOSITORY = new InjectionToken<AuthRepositoryPort>(
	"AUTH_REPOSITORY",
);
 ...
 */
export const SIGN_IN_WITH_EMAIL_USECASE =
	new InjectionToken<SignInWithEmailPort>("SIGN_IN_WITH_EMAIL_USECASE");

/**
 * InjectionToken for the SignInWithGooglePort use case.
 */
export const SIGN_IN_WITH_GOOGLE_USECASE =
	new InjectionToken<SignInWithGooglePort>("SIGN_IN_WITH_GOOGLE_USECASE");

/**
 * InjectionToken for the SignUpPort use case.
 */
export const SIGN_UP_USECASE = new InjectionToken<SignUpPort>(
	"SIGN_UP_USECASE",
);
 ...
 */
export const SIGN_OUT_USECASE = new InjectionToken<SignOutPort>(
	"SIGN_OUT_USECASE",
);
 ...
 */
export const OBSERVE_AUTH_STATE_USECASE =
	new InjectionToken<ObserveAuthStatePort>("OBSERVE_AUTH_STATE_USECASE");
...
export const provideAuth = (): EnvironmentProviders => {
	return makeEnvironmentProviders([
		...
		},
		{
			...
			useFactory: (authRepository: AuthRepositoryPort) =>
				new SignInWithGoogleUseCase(authRepository),
			deps: [AUTH_REPOSITORY],
		},
		{
			provide: SIGN_IN_WITH_EMAIL_USECASE,
			useFactory: (authRepository: AuthRepositoryPort) =>
				new SignInWithEmailUseCase(authRepository),
			deps: [AUTH_REPOSITORY],
		},
		{
		...
		},
		{
			...
			useFactory: (authRepository: AuthRepositoryPort) =>
				new ObserveAuthStateUseCase(authRepository),
			deps: [AUTH_REPOSITORY],
		},
	]);
};
